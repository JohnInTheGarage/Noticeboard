 ...
 *
 * ---------------------------------------------------------- Set up "crontab
 * -e" with these lines to reboot pi daily and turn screen off overnight 59 23 *
 * * * /usr/bin/sudo sh -c "echo 1 >
 * /sys/class/backlight/rpi_backlight/bl_power" 00 06 * * * /usr/bin/sudo sh -c
 ...
 * kept in directory /etc/profile.d e.g. export
